  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Rush Slide is a puzzle game where players must create a path for the red piece to exit a congested grid by manoeuvring other pieces using logic and strategy."
        />
